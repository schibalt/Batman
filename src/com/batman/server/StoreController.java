...
public class StoreController extends HttpServlet {
	private final static Logger log = Logger.getLogger(StoreController.class.getName(), null);
	...
	protected void doGet(HttpServletRequest request,
		...
		ItemGoogleSqlDAO itemDao = new ItemGoogleSqlDAO();
	...
	private void updateCart(HttpServletRequest request,
		...
		Item itemToAdd = null;
		// Iterate over the items to find the one that has the appropriate guid
		// This is necessary to retrieve the price of the item
		for (Item item : items) {
			if (item.getGuid().contains(guid)) {
				itemToAdd = item;
				break;
			}
		}
